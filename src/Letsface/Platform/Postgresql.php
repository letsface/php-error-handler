...
class Postgresql
{
    const SUCCESSFUL_COMPLETION_CLASS = '00000';
    const SUCCESSFUL_COMPLETION = self::SUCCESSFUL_COMPLETION_CLASS;

    const WARNING_CLASS = '01000';
    const WARNING_DYNAMIC_RESULT_SETS_RETURNED = '0100C';
    ...
    const WARNING_STRING_DATA_RIGHT_TRUNCATION = "01004";
    const WARNING_DEPRECATED_FEATURE = "01P01";

    const NO_DATA = "02000";
    const NO_DATA_NO_ADDITIONAL_DYNAMIC_RESULT_SETS_RETURNED = "02001";
    ...
    const CONNECTION_SQLCLIENT_UNABLE_TO_ESTABLISH_SQLCONNECTION = "08001";
    const CONNECTION_SQLSERVER_REJECTED_ESTABLISHMENT_OF_SQLCONNECTION = "08004";
    const CONNECTION_TRANSACTION_RESOLUTION_UNKNOWN = "08007";
    const CONNECTION_PROTOCOL_VIOLATION = "08P01";
    ...
    const DATA_ARRAY_SUBSCRIPT_ERROR = "2202E";
    const DATA_CHARACTER_NOT_IN_REPERTOIRE = "22021";
    const DATA_DATETIME_FIELD_OVERFLOW = "22008";
    const DATA_DIVISION_BY_ZERO = "22012";
    const DATA_ERROR_IN_ASSIGNMENT = "22005";
    const DATA_ESCAPE_CHARACTER_CONFLICT = "2200B";
    const DATA_INDICATOR_OVERFLOW = "22022";
    const DATA_INTERVAL_FIELD_OVERFLOW = "22015";
    const DATA_INVALID_ARGUMENT_FOR_LOGARITHM = "2201E";
    const DATA_INVALID_ARGUMENT_FOR_NTILE_FUNCTION = "22014";
    const DATA_INVALID_ARGUMENT_FOR_NTH_VALUE_FUNCTION = "22016";
    const DATA_INVALID_ARGUMENT_FOR_POWER_FUNCTION = "2201F";
    const DATA_INVALID_ARGUMENT_FOR_WIDTH_BUCKET_FUNCTION = "2201G";
    const DATA_INVALID_CHARACTER_VALUE_FOR_CAST = "22018";
    const DATA_INVALID_DATETIME_FORMAT = "22007";
    const DATA_INVALID_ESCAPE_CHARACTER = "22019";
    const DATA_INVALID_ESCAPE_OCTET = "2200D";
    const DATA_INVALID_ESCAPE_SEQUENCE = "22025";
    const DATA_NONSTANDARD_USE_OF_ESCAPE_CHARACTER = "22P06";
    const DATA_INVALID_INDICATOR_PARAMETER_VALUE = "22010";
    const DATA_INVALID_PARAMETER_VALUE = "22023";
    const DATA_INVALID_REGULAR_EXPRESSION = "2201B";
    const DATA_INVALID_ROW_COUNT_IN_LIMIT_CLAUSE = "2201W";
    const DATA_INVALID_ROW_COUNT_IN_RESULT_OFFSET_CLAUSE = "2201X";
    const DATA_INVALID_TIME_ZONE_DISPLACEMENT_VALUE = "22009";
    const DATA_INVALID_USE_OF_ESCAPE_CHARACTER = "2200C";
    const DATA_MOST_SPECIFIC_TYPE_MISMATCH = "2200G";
    const DATA_NULL_VALUE_NOT_ALLOWED = "22004";
    const DATA_NULL_VALUE_NO_INDICATOR_PARAMETER = "22002";
    const DATA_NUMERIC_VALUE_OUT_OF_RANGE = "22003";
    const DATA_STRING_DATA_LENGTH_MISMATCH = "22026";
    const DATA_STRING_DATA_RIGHT_TRUNCATION = "22001";
    const DATA_SUBSTRING_ERROR = "22011";
    const DATA_TRIM_ERROR = "22027";
    const DATA_UNTERMINATED_C_STRING = "22024";
    const DATA_ZERO_LENGTH_CHARACTER_STRING = "2200F";
    const DATA_FLOATING_POINT_EXCEPTION = "22P01";
    const DATA_INVALID_TEXT_REPRESENTATION = "22P02";
    const DATA_INVALID_BINARY_REPRESENTATION = "22P03";
    const DATA_BAD_COPY_FILE_FORMAT = "22P04";
    const DATA_UNTRANSLATABLE_CHARACTER = "22P05";
    const DATA_NOT_AN_XML_DOCUMENT = "2200L";
    const DATA_INVALID_XML_DOCUMENT = "2200M";
    const DATA_INVALID_XML_CONTENT = "2200N";
    const DATA_INVALID_XML_COMMENT = "2200S";
    const DATA_INVALID_XML_PROCESSING_INSTRUCTION = "2200T";

    const CONSTRAINT_INTEGRITY_CONSTRAINT_VIOLATION = "23000";
    const CONSTRAINT_RESTRICT_VIOLATION = "23001";
    const CONSTRAINT_NOT_NULL_VIOLATION = "23502";
    const CONSTRAINT_FOREIGN_KEY_VIOLATION = "23503";
    const CONSTRAINT_UNIQUE_VIOLATION = "23505";
    const CONSTRAINT_CHECK_VIOLATION = "23514";
    const CONSTRAINT_EXCLUSION_VIOLATION = "23P01";

    const INVALID_CURSOR_STATE = "24000";

    const TRANSACTION_INVALID_TRANSACTION_STATE = "25000";
    const TRANSACTION_ACTIVE_SQL_TRANSACTION = "25001";
    const TRANSACTION_BRANCH_TRANSACTION_ALREADY_ACTIVE = "25002";
    const TRANSACTION_HELD_CURSOR_REQUIRES_SAME_ISOLATION_LEVEL = "25008";
    const TRANSACTION_INAPPROPRIATE_ACCESS_MODE_FOR_BRANCH_TRANSACTION = "25003";
    const TRANSACTION_INAPPROPRIATE_ISOLATION_LEVEL_FOR_BRANCH_TRANSACTION = "25004";
    const TRANSACTION_NO_ACTIVE_SQL_TRANSACTION_FOR_BRANCH_TRANSACTION = "25005";
    const TRANSACTION_READ_ONLY_SQL_TRANSACTION = "25006";
    const TRANSACTION_SCHEMA_AND_DATA_STATEMENT_MIXING_NOT_SUPPORTED = "25007";
    const TRANSACTION_NO_ACTIVE_SQL_TRANSACTION = "25P01";
    const TRANSACTION_IN_FAILED_SQL_TRANSACTION = "25P02";
    ...
    const SQL_ROUTINE_FUNCTION_EXECUTED_NO_RETURN_STATEMENT = "2F005";
    const SQL_ROUTINE_MODIFYING_SQL_DATA_NOT_PERMITTED = "2F002";
    const SQL_ROUTINE_PROHIBITED_SQL_STATEMENT_ATTEMPTED = "2F003";
    const SQL_ROUTINE_READING_SQL_DATA_NOT_PERMITTED = "2F004";

    const INVALID_CURSOR_NAME = "34000";

    const EXTERNAL_ROUTINE_EXCEPTION = "38000";
    const EXTERNAL_ROUTINE_CONTAINING_SQL_NOT_PERMITTED = "38001";
    const EXTERNAL_ROUTINE_MODIFYING_SQL_DATA_NOT_PERMITTED = "38002";
    const EXTERNAL_ROUTINE_PROHIBITED_SQL_STATEMENT_ATTEMPTED = "38003";
    const EXTERNAL_ROUTINE_READING_SQL_DATA_NOT_PERMITTED = "38004";

    const EXTERNAL_ROUTINE_INVOCATION_EXCEPTION = "39000";
    const EXTERNAL_INVALID_SQLSTATE_RETURNED = "39001";
    const EXTERNAL_NULL_VALUE_NOT_ALLOWED = "39004";
